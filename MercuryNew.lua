...
function Library:create(options)
	...
	creditsTab:credit{Name = "Bostonstrong567", Description = "Script Dev", Discord = "bostonstrong567#1595", V3rmillion = "bostonstrong567"}
	creditsTab:credit{Name = "Discord Server", Description = "Join the discord", Discord = "https://discord.gg/EC3zPShvBq"}
	return mt
end
